    ...
    while True:
        ...
        if choice == "1":
            ...
            if len(parts) == 2 and parts[0].isdigit() and parts[1].isdigit():
                ...
                ok, msg = student_service.register(code, section)
                print(msg)
                print(f"현재 총 신청 학점: {student_service.current_credits()} / 18")
                ...
                ok, msg = student_service.register(selected.code, selected.section)
                print(msg)
                print(f"현재 총 신청 학점: {student_service.current_credits()} / 18")
        elif choice == "6":
